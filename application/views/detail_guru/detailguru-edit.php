...
<body>
  <div class="content">
    ...
    <?php echo form_open_multipart("detail_guru_controller/ubah/".$detail_guru->kode_detail_guru); ?>
      <div class="row">
        <div class="col-3">
        ...
        <div class="col-8">
           <select name="nip" id="nip">
            ...
            ?>
              <option value='<?php echo $data->nip ?>' <?php if($detail_guru->nip == $data->nip ){ echo 'selected';} ?> ><?php echo $data->nip.' \ '.$data->nama_guru ?></option>
            <?php
            }
            ?>
          </select>
      ...
      <div class="row">
        ...
        <div class="col-8">
           <select name="kode_mapel" id="kode_mapel">
            ...
            ?>
            <option value='<?php echo $data->kode_mapel ?>' <?php if($detail_guru->kode_mapel == $data->kode_mapel ){ echo 'selected';} ?> ><?php echo $data->nama_mapel ?></option>
            <?php
              }
            ?>
          </select>
      ...
      <input type="text" name="kode_kelas" value="<?php echo $detail_guru->kode_kelas ?>">
